            ...
            >
                {
                    product.map((data) => (
                        <div key={data._id} >
                            <SwiperSlide className=' flex justify-center border hover:shadow-md hover:shadow-gray-600 hover:scale-105 hover:duration-200 rounded-sm p-4 relative group' onClick={() => navigate(`/product/${data._id}`)}>
                                 <div>
